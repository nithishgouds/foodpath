...
import './organstructure.css'


function Organstructure(){

  const [braincolor, setBrainColor] = useState('#000000');
  const [lungscolor, setlungsColor] = useState('#000000');
  ...
  const fetchOrganStatus = async () => {
    try {
        const response = await axios.get('http://localhost:3001/api/organs/organ-status'); // Adjust the URL as needed
