      ...
      <div class="model2d" >
        <svg
          ...
          <g className="layer" style={{ display: 'inline' }}>
            ...
            <g fillOpacity={opacity} className='path-intestine' onClick={() => handleSvgClick('intestines')} fill={intestinecolor} id="intestine" stroke="rgb(255, 128, 128)" transform="matrix(1 0 0 1 0 0)">
