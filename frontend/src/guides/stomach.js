...
<<<<<<< HEAD
           ...
           viewport={{ once: true }}>
                    ...
                    <h5  className='head5'>Yogurt</h5><br></br>
                    <p className='foodpara'><p className = "foodtext">Probiotics:</p > Contains healthy bacteria that aid digestion and reduce bloating.</p><br></br>
                   
                    <p className='foodpara'><p className = "foodtext">Supports Gut Health:</p > Helps balance the gut microbiome, improving overall stomach function.</p><br></br>
 
                    <p className='foodpara'><p className = "foodtext">Reduces Inflammation:</p > Can soothe stomach discomfort and reduce inflammation in the digestive tract.</p><br></br>
                    </motion.div>
                </article>
           ...
           viewport={{ once: true }}>
                  <div class="particle"></div>
                    ...
                    <p className='foodpara'><p className = "foodtext">Reduces Nausea:</p > Helps alleviate nausea and vomiting caused by digestive issues.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Anti-Inflammatory:</p > Reduces inflammation in the stomach and promotes digestion.</p><br></br>
                   
                
                    <p className='foodpara'><p className = "foodtext">Soothes Upset Stomach:</p > Ginger is known for its ability to calm an upset stomach and ease discomfort.</p><br></br>
           ...
           viewport={{ once: true }}>
                    ...
                    <p className='foodpara'><p className = "foodtext">High in Fiber:</p > Bananas help regulate bowel movements and prevent constipation.</p><br></br>
                    
                    <p className='foodpara'><p className = "foodtext">Eases Acid Reflux:</p > Bananas are alkaline, which can neutralize stomach acid and reduce acid reflux.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Gentle on the Stomach:</p > Easy to digest and soothing for the digestive tract.</p><br></br>
  ...
  <article className="food-itemr">
    <img src="https://th.bing.com/th?id=OIP.b9It-_1kiy-uxqOalKV1JwHaE8&w=306&h=204&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'> Oats</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Rich in Fiber:</p > Supports healthy digestion and prevents bloating.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Soothing Properties:</p > Helps with acid reflux and stomach discomfort.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Easy to Digest:</p > Gentle on the stomach, promoting regular bowel movements.</p><br></br>
      </motion.div>
  </article>

  <article className="food-iteml">
    <img src="https://th.bing.com/th?id=OIP.B6H6YbqQV6QElTzXnyqJQAHaFm&w=287&h=217&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" 
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Papaya</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Contains Papain:</p > Aids in digestion and breaks down proteins for better absorption.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Prevents Bloating:</p > Reduces gas and eases bloating.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Soothing Effect:</p > Helps prevent and treat stomach ulcers.</p><br></br>
      </motion.div>
  </article>

  <article className="food-itemr">
    <img src="https://www.bing.com/th/id/OIP.3k37mbku3Ck4MPYbWlyzEQAAAA?w=173&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Applesauce</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Rich in Fiber:</p > Helps regulate bowel movements and supports digestion.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Gentle on Stomach:</p > Easy to digest and soothing for an upset stomach.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Contains Pectin:</p > Promotes healthy gut bacteria.</p><br></br>
      </motion.div>
  </article>

  <article className="food-iteml">
    <img src="https://www.bing.com/th/id/OIP.u_bOkum5Sors7I-hGw8g1QAAAA?w=135&h=155&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Fennel</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Reduces Gas:</p > Helps reduce bloating and gas.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Promotes Digestion:</p > Contains anethole, which stimulates the secretion of digestive juices.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Soothes Stomach Cramps:</p > Eases discomfort and stomach pain.</p><br></br>
      </motion.div>
  </article>

  <article className="food-itemr">
    <img src="https://www.bing.com/th/id/OIP.ohGRKK_P-7-QMXceBrs8XQHaE8?w=284&h=189&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Rice (Plain)</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Easy to Digest:</p > Gentle on the stomach and non-irritating.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Low in Fiber:</p > Helps with diarrhea by absorbing fluids.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Calms the Stomach:</p > Provides energy without triggering stomach issues.</p><br></br>
      </motion.div>
  </article>

  <article className="food-iteml">
    <img src="https://www.bing.com/th/id/OIP.M7Fmc9-pq3L9_rZwhedxlAHaEz?w=249&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'> Chamomile Tea</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Reduces Inflammation:</p > Has anti-inflammatory properties to soothe the stomach.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Relieves Nausea:</p > Can reduce nausea and stomach cramping.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Calms Stomach Pain:</p > Eases overall discomfort.</p><br></br>
      </motion.div>
  </article>

  <article className="food-itemr">
    <img src="https://www.bing.com/th/id/OIP.X7y8DeC2H-_GZZf6JKb5XAHaFW?w=244&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Sweet Potatoes</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Rich in Fiber:</p > Supports digestion and promotes gut health.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Contains Vitamin A:</p > Supports a healthy stomach lining.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Easy to Digest:</p > Gentle on the stomach.</p><br></br>
      </motion.div>
  </article>
              </section>
           ...
           whileInView="visible"
           viewport={{ once: true }}>
                    <h5  className='head5'>Spicy Foods</h5><br></br>

                    <p className='foodpara'><p className = "foodtext">Increases Stomach Acid:</p > Can irritate the stomach lining and lead to indigestion or heartburn.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > Spicy foods can cause the lower esophageal sphincter to relax, leading to acid reflux.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Causes Stomach Discomfort:</p > Spicy foods may cause discomfort, bloating, or gas for sensitive individuals.</p><br></br>
           ...
           viewport={{ once: true }}>
                  <div class="nparticle"></div>
                    ...
                    <h5  className='head5'>Fried Foods</h5><br></br>
                    <p className='foodpara'><p className = "foodtext">Hard to Digest:</p > High-fat content in fried foods slows digestion and can cause stomach discomfort.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Increases Acid Production:</p > Fried foods can lead to excessive stomach acid, causing indigestion or acid reflux.</p><br></br>

                    <p className='foodpara'><p className = "foodtext">Leads to Bloating:</p > Greasy foods can cause bloating and gas, making the stomach feel heavy.</p><br></br>
                    </motion.div>
                </article>
           ...
           whileInView="visible"
           viewport={{ once: true }}>
                    <h5  className='head5'>Carbonated Beverages (Soda, Sparkling Water)</h5><br></br>
                    <p className='foodpara'><p className = "foodtext">Causes Bloating:</p > The gas in carbonated drinks can cause bloating and discomfort in the stomach.</p><br></br>
                    <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > Carbonation can lead to acid reflux and exacerbate heartburn.</p><br></br>
                   
                    <p className='foodpara'><p className = "foodtext">Disrupts Digestion:</p > These beverages can slow digestion, leading to gas and stomach pain.</p><br></br>
                    </motion.div>
                  <div class="nparticle"></div>
   ...
   < motion.div
      ...
      <p className='foodpara'><p className = "foodtext">High in Fat and Preservatives:</p > Can irritate the stomach and slow digestion.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Contains Additives:</p > May lead to bloating and discomfort.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Hard to Digest:</p > Processed meats can be challenging for the stomach to break down.</p><br></br>
      </motion.div>
  </article>
  ...
  <article className="food-iteml">
   ...
   < motion.div
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Citrus Fruits</h5><br></br>
      <p className='foodpara'><p className = "foodtext">High in Acid:</p > Can irritate the stomach lining and cause discomfort.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > The acidic nature can lead to heartburn and indigestion.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Can Cause Stomach Pain:</p > Particularly in people with sensitive stomachs or ulcers.</p><br></br>
      </motion.div>
  </article>
  ...
  <article className="food-itemr">
   ...
   < motion.div
      ...
      <p className='foodpara'><p className = "foodtext">Increases Acid Production:</p > Can lead to acid reflux and gastritis.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Weakens Stomach Lining:</p > Excessive alcohol intake can damage the stomach lining, causing ulcers.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Slows Digestion:</p > May lead to bloating and discomfort.</p><br></br>
      </motion.div>
  </article>

  <article className="food-iteml">
    <img src="https://tse4.mm.bing.net/th/id/OIP.UNWx5QnfFvyIes0hv4rdwgHaGK?w=232&h=193&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'> High-Fat Dairy</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Hard to Digest:</p > High-fat content can lead to bloating and gas.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > Fatty foods can relax the lower esophageal sphincter.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Can Cause Discomfort:</p > May irritate those with lactose intolerance or sensitivity.</p><br></br>
      </motion.div>
  </article>
  ...
  <article className="food-itemr">
   ...
   < motion.div
      ...
      <p className='foodpara'><p className = "foodtext">Disrupts Gut Health:</p > May affect healthy gut bacteria.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Causes Gas and Bloating:</p > Some artificial sweeteners, like sorbitol, are hard to digest.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Leads to Stomach Pain:</p > Can cause cramps in sensitive individuals.</p><br></br>
      </motion.div>
  </article>
  ...
  <article className="food-iteml">
   ...
   < motion.div
           ...
           whileInView="visible"
           viewport={{ once: true }}>
      <h5 className='head5'>Chocolate</h5><br></br>
      <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > Contains caffeine and fat, which can increase acid production.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Relaxes Esophageal Sphincter:</p > Can cause acid to flow back into the esophagus.</p><br></br>
      <p className='foodpara'><p className = "foodtext">May Lead to Discomfort:</p > Especially if consumed in large quantities.</p><br></br>
      </motion.div>
  </article>

  <article className="food-itemr">
    <img src="https://www.bing.com/th/id/OIP.AXrK0kpXxixXz-IAHZsqsQHaFj?w=219&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image" />
   < motion.div
           className="food-contentl"
      ...
      <p className='foodpara'><p className = "foodtext">Triggers Acid Reflux:</p > Can relax the lower esophageal sphincter and cause heartburn.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Causes Gas:</p > Onions are known to cause bloating and gas.</p><br></br>
      <p className='foodpara'><p className = "foodtext">Can Cause Discomfort:</p > Especially when consumed raw.</p><br></br>
    </motion.div>
  </article>
              </section>
=======
          ...
          <section className="good-foods" style={{display: 'flex', flexWrap: 'wrap', gap: '20px'}}>
            ...
            <div className="card-container" style={{display: 'flex', flexWrap: 'wrap', gap: '20px'}}>
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://th.bing.com/th/id/OIP.2QSmRTj6xUNhxY0Hjbb5kQHaE8?w=305&h=203&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.H8K65thA0tyyjjIoYNV5swHaHa&w=200&h=198&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://th.bing.com/th?id=OIP.sPpeQTSom3zN3OU2M8MS0QHaFj&w=252&h=190&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.fRzV63u1b2p5iJ1Lg7_YPQHaFj&w=220&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.v0le9dFrGheI-x5uV1u6AAHaHa&w=212&h=212&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.oRXUt8VrDozV_oBCe4ymHgHaEK&w=309&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
          ...
          <section className="bad-foods" style={{display: 'flex', flexWrap: 'wrap', gap: '20px'}}>
            ...
            <div className="card-container" style={{display: 'flex', flexWrap: 'wrap', gap: '20px'}}>
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.xvCHbEsSpHzjWqHYH2WsqAHaEK&w=309&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.VGR2MnAEd6EV_y7P1czHgQHaE8&w=300&h=200&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.tNQugbykR4SdjOX2RbeNjgHaEK&w=312&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.RDpDD25rtvDMeK0C7VePpAHaEK&w=300&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.vHRlT5Jo67uZZhLjU6aupgHaFj&w=252&h=190&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.oXwZmU0bU9_zOlz9jMR1RgHaE8&w=306&h=204&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.l5IGoSmErRjyK7Z9tG8vlAHaE8&w=306&h=204&c=7&r=0&o=5&dpr=1.3&pid=1.7"
              ...
              <motion.article className="food-card" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}
                              initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                <img
                    src="https://www.bing.com/th?id=OIP.KCPTJUNQjK8WNSrTFKlgYAHaE8&w=305&h=203&c=7&r=0&o=5&dpr=1.3&pid=1.7"
