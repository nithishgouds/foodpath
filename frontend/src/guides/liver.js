...
function Liver(){
  const [guides_liver_status_text, setguides_liver_status_text] = useState("Analysing...");
  const [guides_liver_consumed_text, setguides_liver_consumed_text] = useState("Getting...");
  const [guides_liver_info_text, setguides_liver_info_text] = useState("Analysing...");
