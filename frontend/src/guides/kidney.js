    ...
    <p>{guides_kidney_info_text}</p>
      ...
      <section className="good-foods">
        ...
        <article className="food-iteml">
          ...
          <div className="food-contentl">
            <h5 className="head5"> Red Bell Peppers</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Low in Potassium:</p> Helps reduce the
              workload on kidneys.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Vitamins:</p> Rich in vitamin C
              and antioxidants.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            <h5 className="head5">Cabbage</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Nutrient-Rich:</p> Contains vitamins C, K,
              and B, with very low potassium.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Antioxidant Benefits:</p> Helps combat
              free radicals.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5">Cauliflower</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Detoxifying Agent:</p> Contains compounds
              that neutralize toxins.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Rich in Vitamins:</p> Provides vitamin C
              and fiber.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Flavor Enhancer:</p> Reduces the need for
              added salt.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-iteml">
          ...
          <div className="food-contentl">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Low in Potassium:</p> Great for
              kidney-friendly diets.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Rich in Antioxidants:</p> Contains
              quercetin to fight free radicals.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Fiber:</p> Supports heart health
              and digestion.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Anti-Inflammatory:</p> Reduces kidney
              inflammation.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5">Cranberries</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Prevents UTIs:</p> Supports bladder and
              kidney health.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Rich in Antioxidants:</p> Good for overall
              kidney function.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Antioxidants:</p> Reduces
              inflammation and supports kidneys.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Low in Potassium:</p> Safe for kidney
              diets.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5">Strawberries</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Nutrient-Dense:</p> Contains antioxidants
              and vitamins.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Protects Against Damage:</p> Reduces
              oxidative stress on kidneys.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-itemr">
          ...
          />
          <div className="food-contentr">
            <h5 className="head5"> Fish (Salmon, Mackerel)</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Omega-3 Fatty Acids:</p> Reduces
              inflammation and improves blood pressure.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Supports Heart Health:</p> Essential for
              kidney health.
            </p>
            <br></br>
          </div>
      ...
      <section className="bad-foods">
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5">Processed Meats (Hot Dogs, Sausages)</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Sodium:</p> Increases blood
              pressure and kidney strain.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Preservatives:</p> Contains additives
              harmful to kidneys.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-itemr">
          ...
          />
          <div className="food-contentr">
            <h5 className="head5">Canned Foods</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Sodium:</p> Can lead to water
              retention and kidney strain.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Preservatives:</p> Chemicals in canned
              foods are harsh on kidneys.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5"> Soda and Sugary Drinks</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Sugar:</p> Increases risk of
              diabetes and kidney disease.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Contributes to Dehydration:</p> Puts
              additional strain on kidneys.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Dehydrating:</p> Causes kidney dehydration
              and impairs function.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Toxic Metabolites:</p> Puts extra pressure
              on the kidneys to filter.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-iteml">
          ...
          <div className="food-contentl">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Hard to Digest:</p> Can lead to
              constipation and strain kidneys.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Linked to Cancer:</p> High consumption
        ...
        <article className="food-itemr">
          ...
          />
          <div className="food-contentr">
            <h5 className="head5">Dairy Products</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Phosphorus:</p> Can lead to
              weakened bones for those with kidney issues.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High Protein Load:</p> May increase kidney
              workload.
            </p>
            <br></br>
          </div>{" "}
        ...
        <article className="food-iteml">
          ...
          <div className="food-contentl">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Potassium:</p> Can be harmful for
              those with compromised kidney function.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Leads to Hyperkalemia:</p> Excess
              potassium can affect heart function.
            </p>
            <br></br>
          </div>{" "}
        </article>
        ...
        <article className="food-itemr">
          ...
          <div className="food-contentr">
            ...
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Potassium:</p> Too much potassium
              can strain kidneys.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Should Be Limited:</p> Best avoided for
        ...
        <article className="food-iteml">
          ...
          />
          <div className="food-contentl">
            <h5 className="head5">Oranges and Orange Juice</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Potassium:</p> Not suitable for
              people with kidney problems.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Leads to Hyperkalemia:</p> Can disrupt
        ...
        <article className="food-itemr">
          ...
          />
          <div className="food-contentr">
            <h5 className="head5">Pickled and Fermented Foods</h5>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">High in Sodium:</p> Can cause fluid
              retention and increase blood pressure.
            </p>
            <br></br>
            <p className="foodpara">
              <p className="foodtext">Strains Kidneys:</p> Excess sodium can
