...
<<<<<<< HEAD
        ...
        <motion.img src="https://th.bing.com/th/id/OIP.L1KZ9kz1QJoYJ089IYH4jQHaFV?w=294&h=212&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"
        alt='.'
        ...
        <article className="food-itemr">
            ...
            <motion.img src="https://tse4.mm.bing.net/th/id/OIP.l2WJdPUIQezUJc6rRxv9EAHaE7?w=264&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
...
Folate and B vitamins also play a role in reducing the risk of depression and cognitive impairment.</p> <br></br>
        ...
        <article className="food-iteml">
            <motion.img src="https://www.bing.com/th/id/OIP.GEyLT9N8t1gV5pXZDNXHUAHaFg?w=259&h=192&c=7&r=0&o=5&dpr=1.3&pid=1.7"
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
          ...
          <article className="food-itemr">
            <motion.img src="https://www.bing.com/th?id=OIP.j1WfA-1HnuUuicubXhR1OwHaEq&w=315&h=198&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" 
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
          ...
          <article className="food-iteml">
            <motion.img src="https://www.bing.com/th/id/OIP.tWq2a6lTpuwIa-4U4dWjSgAAAA?w=188&h=141&c=7&r=0&o=5&dpr=1.3&pid=1.7"
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
          ...
          <article className="food-itemr"> <div class="particle"></div>
            ...
            <motion.img src="https://th.bing.com/th?id=OIP.Qmk7f6puo63EoqkKdIAP-QAAAA&w=300&h=199&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
          ...
          <article className="food-iteml">
            <motion.img src="https://www.bing.com/th/id/OIP.p6e_BQT1_HF222FsOhSgYAHaE8?w=252&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
            alt='.'
             className="food-image"
            initial="hidden"
             whileInView="visible"
          ...
          <article className="food-itemr">
            <motion.img src="https://www.pngmart.com/files/15/Avocado-PNG-Transparent-HD-Photo.png"
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
  ...
  <div class="nparticle"></div>
        ...
        <article className="food-iteml">
            ...
            <motion.img src="https://tse1.mm.bing.net/th/id/OIP.3B3kU6ZYJdDzN8b1jdeh6QHaFc?w=245&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
        ...
        <article className="food-itemr">
            ...
            <motion.img src="https://tse1.mm.bing.net/th/id/OIP.WFyvuU65H6puydI-H1yxwQHaGg?w=223&h=196&c=7&r=0&o=5&dpr=1.3&pid=1.7"
            alt='.'
            className="food-image"
            initial="hidden"
             whileInView="visible"
  ...
  <article className="food-iteml">
    <motion.img src="https://www.bing.com/th/id/OIP.YHffM3-8eeJZMh-kQnhvPQAAAA?w=186&h=159&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image"
    initial="hidden"
     whileInView="visible"
  ...
  <article className="food-itemr">
    <motion.img src="https://tse1.mm.bing.net/th/id/OIP.CW22Grctx2l5DxNmU4wZ5gHaEn?w=274&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image"
         initial="hidden"
          whileInView="visible"
  ...
  <article className="food-iteml">
    <motion.img src="https://www.bing.com/th/id/OIP.BEH8rpIxoiUt_AQDRmSYTAHaFY?w=240&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
    alt='.'
    className="food-image"
         initial="hidden"
          whileInView="visible"
  ...
  <article className="food-itemr">
    <motion.img src="https://www.bing.com/th/id/OIP.p_pebnS80ESbaxIixeE25gAAAA?w=210&h=182&c=7&r=0&o=5&dpr=1.3&pid=1.7" 
  ...
  <article className="food-iteml">
    <motion.img src="https://www.venturafoods.com/wp-content/uploads/2022/02/margerines-spreads.png"
    alt='.'
    className="food-image"
    initial="hidden"
     whileInView="visible"
  ...
  <article className="food-itemr">
    <motion.img src="https://www.bing.com/th/id/OIP.8ZANzjQpk38obzYbB9GKYwAAAA?w=179&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
    alt='.'
    className="food-image"
    initial="hidden"
     whileInView="visible"
