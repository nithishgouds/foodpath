    ...
    return (
        <div className="about-text ml-14 pl-3 mt-20 pt-9 text-custom-blue">
            ...
            <motion.p
                ...
                style={{lineHeight: "1.5", fontSize: "1.3rem"}}
                initial={{opacity: 0, x: '100%'}} // Correct usage for initial position
                whileInView={{opacity: 1, x: '90%'}} // Correct final position
            ...
            >
                We make healthy eating enjoyable and sustainable with personalized recommendations and interactive
                tools.
            </motion.p>
        </div>
    );
