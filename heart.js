  ...
  const [guides_heart_info_text, setguides_heart_info_text] = useState("This is the initial text.");
    return(
       ...
       <div className='newflex'>
          ...
          <h3>Current Status Of The Heart</h3>
...
{guides_heart_consumed_text}
          ...
          <div class="container">
          <div className='food-item-i'>
  <p className='guides_heart_info_text'> {guides_heart_info_text}</p></div>
  <img src="https://tse2.mm.bing.net/th/id/OIP.IJ71QVkK8UAyruTKY8TorgHaE8?rs=1&pid=ImgDetMain"
  alt="Heart"
  className="food-image-i"/>
        ...
        <section className="good-foods">
          ...
          <article className="food-item"><div class="particle"></div>
            <img 
        ...
        <section className="bad-foods">
          ...
          <article className="food-item">
            <img 
              ...
              className="food-image"
            /> 
            <div className="food-content"> <div class="nparticle"></div>
              <h2>1. Processed Meats (Bacon, Sausage, Hot Dogs)</h2>
